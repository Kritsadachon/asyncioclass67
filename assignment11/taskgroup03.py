...
async def checkout_customer(queue: Queue, cashier_number: int):
    ...
    while not queue.empty():
        ...
        for product in customer.products:
            ...
            print(f"The Cashier_{cashier_number} will checkout Customer_{customer.customer_id}'s "
                  f"Product_{product.product_name} for {adjusted_checkout_time} secs")
    ...
    print(f"=====The Cashier_{cashier_number+1} took {customers_served} customers total {total_time} secs.")
